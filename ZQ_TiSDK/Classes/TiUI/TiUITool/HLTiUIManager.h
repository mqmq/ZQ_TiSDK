 ...
 * 点击退出手势
 */
- (void)heliao_didClickOnExitTap;
/**
 * 切换摄像头
 */
- (void)heliao_didClickSwitchCameraButton;
/**
 * 拍照
 */
- (void)heliao_didClickCameraCaptureButton;

@end

@interface HLTiUIManager : NSObject
/**
*   初始化单例
*/
...
*/
@property(nonatomic) BOOL heliao_showsDefaultUI;

//主窗口
@property(nonatomic, strong) UIWindow *heliao_superWindow;
...
//默认UI按钮
@property(nonatomic, strong) HLTiUIDefaultButtonView *heliao_defaultButton;
...
//美颜模块主要功能UI
@property(nonatomic, strong) HLTiUIMainMenuView *heliao_tiUIViewBoxView;
